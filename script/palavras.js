let palavrasValidas =
    ["SAGAZ", "AMORA", "PINTO", "AMAGO", "NEGRO", "EXITO", "MEXER", "TERMO", "NOBRE", "SENSO",
        ...
        "MODAL", "FERIR", "GARRA", "VOILA", "ANZOL", "ABADE", "NESGA", "PLUMA", "SOFIA", "OUTRA",
        ...
        "CARIE", "CARAS", "FALAS", "LATIU", "BODES", "SERVA", "SERVE", "RIMOU", "RIMAM", "RIMEI",
        "UNIDO", "UNIDA", "INCAS", "POLOS", "CARGA", "INOVA", "INOVE", "INOVO", "JUNTA", "JULHO",
        "JUNHO", "JUREI", "POCAS", "BASES", "VALSA", "BARCA", "BALSA", "BELAS", "BELOS", "BUSCO",
        "BUSTO", "BEIJE", "DEVEM", "SUMAM", "AMPLA", "ANTAS", "ABONA", "FLUEM", "CABRA", "IRADA",
        "ACENA", "ACENE", "ACENO", "SAIDO", "INDIA", "REZAM", "REZEI", "REZOU", "REZEM", "LIDEI",
        "LADRA", "CASEI", "CASEM", "IRMAS", "CHUTA", "CHUTO", "TRENO", "PONHO", "SUITE", "GALAS",
        "PREZE", "ORFAS", "ARPAO", "REMOU", "REMEI", "POMBO", "POMBA", "RISCA", "CIANO", "SELAM",
        "EXIJA", "MIADO", "ALTAR", "ALTOS", "ALTAS", "ATLAS", "PUNHO", "RICOS", "RICAS", "DOTES",
        "SACOU", "PORAO", "PAGOU", "MANDA", "MANDO", "BOLAO", "BORDA", "CHAMO", "JOIAS", "OPERA",
        "PECOU", "PECAM", "PEGAM", "SECAM", "VALEM", "VALES", "BECOS", "VIELA", "BECAS", "ATIRO",
        "ATIRA", "CURSA", "SALTA", "PULGA", "CANTA", "CANTE", "NOTAS", "GOSTO", "GOSTA", "GOSTE",
        "FALSA", "CALCO", "RENDE", "RENDO", "LIMPE", "FILMO", "LOTOU", "TONTA", "TONTO", "TOLOS",
        "TOLAS", "FALHE", "FALEM", "ATUAM", "UNTAR", "COBRO", "CANSA", "EDITO", "OBESO", "OBESA"]
